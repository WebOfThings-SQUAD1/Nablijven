...
Mario.LoadingState.prototype.Enter = function() {
    ...
    this.Images[0].src = imagePath+"bgsheet.png";
    this.Images[1].src = imagePath+"endscene.gif";
    this.Images[2].src = imagePath+"enemysheet.png";
    this.Images[3].src = imagePath+"firemariosheet.png";
    this.Images[4].src = imagePath+"font.gif";
    this.Images[5].src = imagePath+"gameovergost.gif";
    this.Images[6].src = imagePath+"itemsheet.png";
    this.Images[7].src = imagePath+"logo.gif";
    this.Images[8].src = imagePath+"mapsheet.png";
    this.Images[9].src = imagePath+"mariosheet.png";
    this.Images[10].src = imagePath+"particlesheet.png";
    this.Images[11].src = imagePath+"racoonmariosheet.png";
    this.Images[12].src = imagePath+"smallmariosheet.png";
    this.Images[13].src = imagePath+"title.gif";
    this.Images[14].src = imagePath+"worldmap.png";
